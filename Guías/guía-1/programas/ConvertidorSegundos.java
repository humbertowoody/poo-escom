 ...
 *
 * Problema: 3
 * Planteamiento: Codificar un applet que tenga un botón, tres campos de entrada y una etiqueta. 
...
public class ConvertidorSegundos extends JApplet implements ActionListener {
  ...
  public static void main(String[] args) {
    new ConvertidorSegundos(); // Al instanciar la clase se muestra la ventana.
  }
}
