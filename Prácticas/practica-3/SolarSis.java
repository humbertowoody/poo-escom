 ...
 * SolarSis.java
 *
 * En este archivo se incluye la definición e implementación de la clase SolarSis con la que
 * se muestra una simulación del sistema solar en un ambiente de tres dimensiones utilizando
 * Java3D.
 *
 * No se incluye diagrama UML ya que la clase realmente sólamente conciste en su constructor.
 *
 * Datos:
